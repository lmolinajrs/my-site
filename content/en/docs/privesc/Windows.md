...
## <span style="color:#208355">Enumeration
...
## <span style="color:#208355">Service Exploits
...
1. DLL Hijacking
### <span style="color:#208355">Service Enumeration
...
```
### <span style="color:#208355">Listing All Running Services
```shell
...
net stop serv_name
```
### <span style="color:#208355">Exploit Insecure Services Permission
...
```
### <span style="color:#208355">Exploiting Unquoted Service Path
...
#### <span style="color:#208355"> Find Vulnerability
```shell
# Manually
...
```
#### <span style="color:#208355">Test If any directory is writable:
1. Manually
```shell
...
```
#### <span style="color:#208355">Exploit
...
```
#### <span style="color:#208355">Confirm Registry weak permission
```
...
net start SrvName
```
### <span style="color:#208355">DLL Hijacking
...
## <span style="color:#208355">Exploit Startup Program
...
```
## <span style="color:#208355">Exploiting AlwaysInstallElevated
...
```
## <span style="color:#208355">Exploiting Clear Text password
If we are in luck we may found password in clear text.

#### <span style="color:#208355">Finding WIFI password
```
netsh wlan show profile
netsh wlan show profile <SSID> key=clear
```
#### <span style="color:#208355">Search Sensitive Files that may have credential
```
cd C:\
...
```
#### <span style="color:#208355">Search for “Password"
```
...
```
#### <span style="color:#208355">Search Password in Registry
```
...
```
#### <span style="color:#208355">Try With Winpeas:
```
.\winPEAS.exe quiet filesinfo userinfo
```
## <span style="color:#208355">RunAS
Using cmdkey
```shell
cmdkey /list
...
```
## <span style="color:#208355">Exploiting Well known Software
...
```
## <span style="color:#208355">Schedule Task
```
#From CMD
...
### <span style="color:#208355">SeRestorePrivilege
This privilege grant a user to modify service binary, dll, also modify registry settings

### <span style="color:#208355">Others risky Privilege
* SeCreateTokenPrivilege
* SeLoadDriverPrivilege
* SeDebugPrivilege

## <span style="color:#208355">Hot Potato Exploit
...
```
## <span style="color:#208355">Juicy Potato
...
```
## <span style="color:#208355">Rogue Potato
...
## <span style="color:#208355">Useful Commands

### <span style="color:#208355">PowerUp
```powershell
...
```
### <span style="color:#208355">Port Forwarding
```shell
...
```
### <span style="color:#208355">BloodHound
```shell
